...
// TemporaryEmailApi2 SDK proxy feature
...
class TemporaryEmailApi2ProxyFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    public function init(TemporaryEmailApi2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TemporaryEmailApi2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
