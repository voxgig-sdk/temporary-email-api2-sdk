...
// TemporaryEmailApi2 SDK ratelimit feature
...
class TemporaryEmailApi2RatelimitFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _acquire(TemporaryEmailApi2Context $ctx): void
    {
    ...
    private function _track(TemporaryEmailApi2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
