...
// TemporaryEmailApi2 SDK idempotency feature
...
class TemporaryEmailApi2IdempotencyFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _mutating(TemporaryEmailApi2Context $ctx): bool
    {
