...
// TemporaryEmailApi2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class TemporaryEmailApi2TestFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    public function init(TemporaryEmailApi2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (TemporaryEmailApi2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = TemporaryEmailApi2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (TemporaryEmailApi2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(TemporaryEmailApi2Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = TemporaryEmailApi2Param::call($ctx, $k);
