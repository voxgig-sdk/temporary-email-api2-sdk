...
// TemporaryEmailApi2 SDK streaming feature
...
class TemporaryEmailApi2StreamingFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _iterate(TemporaryEmailApi2Result $result): \Generator
    {
    ...
    private function _streamable(TemporaryEmailApi2Context $ctx): bool
    {
