...
// TemporaryEmailApi2 SDK metrics feature
...
class TemporaryEmailApi2MetricsFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _record(TemporaryEmailApi2Context $ctx, bool $ok): void
    {
