...
// TemporaryEmailApi2 SDK telemetry feature
...
class TemporaryEmailApi2TelemetryFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _close(TemporaryEmailApi2Context $ctx, bool $ok): void
    {
