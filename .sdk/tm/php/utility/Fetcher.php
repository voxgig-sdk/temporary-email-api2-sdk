...
// TemporaryEmailApi2 SDK utility: fetcher

class TemporaryEmailApi2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TemporaryEmailApi2SDK/1.0)';
    ...
    public static function call(TemporaryEmailApi2Context $ctx, string $fullurl, array $fetchdef): array
    {
