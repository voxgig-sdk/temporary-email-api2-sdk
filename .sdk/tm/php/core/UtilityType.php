...
// TemporaryEmailApi2 SDK utility type

class TemporaryEmailApi2Utility
{
    ...
    public static function copy(TemporaryEmailApi2Utility $src): TemporaryEmailApi2Utility
    {
        $u = new TemporaryEmailApi2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
