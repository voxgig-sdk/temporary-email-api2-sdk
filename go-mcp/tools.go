...
type Args struct {
	Entity string         `json:"entity" jsonschema:"email_generation | email_inbox"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.TemporaryEmailApi2SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "temporary-email-api2_list",
		Description: "List records from TemporaryEmailApi2. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "temporary-email-api2_load",
		Description: "Load a single record from TemporaryEmailApi2. " +
...
func runOp(client *sdk.TemporaryEmailApi2SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.TemporaryEmailApi2SDK, name string) (sdk.TemporaryEmailApi2Entity, error) {
	switch strings.ToLower(name) {
	case "email_generation":
		return client.EmailGeneration(nil), nil
	case "email_inbox":
		return client.EmailInbox(nil), nil
