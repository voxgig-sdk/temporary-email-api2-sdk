// Command TemporaryEmailApi2-mcp is an MCP server exposing the TemporaryEmailApi2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TemporaryEmailApi2_list  — list records of an entity
//	TemporaryEmailApi2_load  — load a single record of an entity
//
