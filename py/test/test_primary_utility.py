...
from temporaryemailapi2_sdk.utility.voxgig_struct import voxgig_struct as vs
from temporaryemailapi2_sdk import TemporaryEmailApi2SDK
from temporaryemailapi2_sdk.core.spec import TemporaryEmailApi2Spec
from temporaryemailapi2_sdk.core.result import TemporaryEmailApi2Result
from temporaryemailapi2_sdk.core.response import TemporaryEmailApi2Response
from temporaryemailapi2_sdk.core.operation import TemporaryEmailApi2Operation
from temporaryemailapi2_sdk.core.error import TemporaryEmailApi2Error
from temporaryemailapi2_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return TemporaryEmailApi2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except TemporaryEmailApi2Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = TemporaryEmailApi2Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = TemporaryEmailApi2SDK.test(None, None)
        ...
        class TestInitFeature(TemporaryEmailApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(TemporaryEmailApi2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = TemporaryEmailApi2SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = TemporaryEmailApi2SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TemporaryEmailApi2Spec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = TemporaryEmailApi2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = TemporaryEmailApi2SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = TemporaryEmailApi2Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = TemporaryEmailApi2SDK.test(None, setup_opts)
