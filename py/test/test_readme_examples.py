# TemporaryEmailApi2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TemporaryEmailApi2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TemporaryEmailApi2SDK(...) and TemporaryEmailApi2SDK.test(...) become
#      TemporaryEmailApi2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "temporaryemailapi2_sdk"
_SDK_CLASS = "TemporaryEmailApi2SDK"
