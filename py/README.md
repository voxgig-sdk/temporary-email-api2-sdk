# TemporaryEmailApi2 Python SDK



The Python SDK for the TemporaryEmailApi2 API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.EmailGeneration()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/temporary-email-api2-sdk/releases)) or
...
emailgeneration = client.EmailGeneration().load()
# emailgeneration contains the mock response record
```
...
```
py/
├── temporaryemailapi2_sdk.py         -- Main SDK module
