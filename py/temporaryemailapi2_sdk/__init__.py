...
from temporaryemailapi2_sdk.utility import register

# Load features
from temporaryemailapi2_sdk.feature.base_feature import TemporaryEmailApi2BaseFeature
from temporaryemailapi2_sdk.features import _has_feature, _make_feature
...
class TemporaryEmailApi2SDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TemporaryEmailApi2Utility()
        self._utility = utility

        from temporaryemailapi2_sdk.config import shared_config
    ...
    def get_utility(self):
        return TemporaryEmailApi2Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TemporaryEmailApi2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def EmailGeneration(self, data=None) -> "EmailGenerationEntity":
        ...
        from temporaryemailapi2_sdk.entity.email_generation_entity import EmailGenerationEntity
    ...
    def EmailInbox(self, data=None) -> "EmailInboxEntity":
        ...
        from temporaryemailapi2_sdk.entity.email_inbox_entity import EmailInboxEntity
