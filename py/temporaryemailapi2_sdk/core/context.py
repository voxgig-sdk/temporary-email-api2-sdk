...
from temporaryemailapi2_sdk.core.control import TemporaryEmailApi2Control
...
from temporaryemailapi2_sdk.core.helpers import get_ctx_prop, to_map
...
class TemporaryEmailApi2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TemporaryEmailApi2Control()
        ...
        if isinstance(sp, TemporaryEmailApi2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TemporaryEmailApi2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TemporaryEmailApi2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TemporaryEmailApi2Operation({})
        ...
        op = TemporaryEmailApi2Operation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return TemporaryEmailApi2Error(code, msg, self)
