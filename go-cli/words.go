...
func registerSDKWords(r *eng.Registry, client *sdk.TemporaryEmailApi2SDK) {
...
func runOp(client *sdk.TemporaryEmailApi2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
