...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/temporary-email-api2` | `npm install @voxgig-sdk/temporary-email-api2` |
| Python | `voxgig-sdk-temporary-email-api2` | `pip install voxgig-sdk-temporary-email-api2` |
| PHP | `voxgig-sdk/temporary-email-api2` | `composer require voxgig-sdk/temporary-email-api2` |
| Golang | `github.com/voxgig-sdk/temporary-email-api2-sdk/go` | `go get github.com/voxgig-sdk/temporary-email-api2-sdk/go` |
| Ruby | `voxgig-sdk-temporary-email-api2` | `gem install voxgig-sdk-temporary-email-api2` |
| Lua | `voxgig-sdk-temporary-email-api2` | `luarocks install voxgig-sdk-temporary-email-api2` |
