...
describe('EmailInboxDirect', async () => {
  ...
  test('direct-load-email_inbox', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-email_inbox', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['TEMPORARY_EMAIL_API2_TEST_EMAIL_INBOX_ENTID']
