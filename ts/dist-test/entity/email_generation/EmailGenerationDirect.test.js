...
(0, node_test_1.describe)('EmailGenerationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-email_generation', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-email_generation', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['TEMPORARY_EMAIL_API2_TEST_EMAIL_GENERATION_ENTID'];
...
//# sourceMappingURL=EmailGenerationDirect.test.js.map