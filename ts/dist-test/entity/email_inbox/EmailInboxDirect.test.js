...
(0, node_test_1.describe)('EmailInboxDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.TemporaryEmailApi2SDK({
    ...
    (0, node_test_1.test)('direct-load-email_inbox', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-email_inbox', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.TemporaryEmailApi2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['TEMPORARY_EMAIL_API2_TEST_EMAIL_INBOX_ENTID'];
    ...
    const client = new __1.TemporaryEmailApi2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EmailInboxDirect.test.js.map