...
// TemporaryEmailApi2 SDK EmailInbox entity
...
class EmailInboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EmailInboxEntity($this->_client, $opts);
    }

    /**
     * @param EmailInbox|array $args EmailInbox data (assoc-array) to store.
     */
    ...
    /**
     * @return EmailInbox|array The current EmailInbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EmailInbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EmailInbox fields).
     */
    ...
    /**
     * Load a single EmailInbox.
     *
     * @param EmailInboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EmailInboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EmailInbox|array The loaded EmailInbox as an assoc-array at the
