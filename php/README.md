...
The PHP SDK for the TemporaryEmailApi2 API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->EmailGeneration(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->TemporaryEmailApi2(null)->load(
    ["id" => "test01"], null
);
