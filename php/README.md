# TemporaryEmailApi2 PHP SDK



The PHP SDK for the TemporaryEmailApi2 API — an entity-oriented client using PHP conventions.
...
```
php/
├── temporaryemailapi2_sdk.php          -- Main SDK class
...
The main class (`temporaryemailapi2_sdk.php`) exports the SDK class
