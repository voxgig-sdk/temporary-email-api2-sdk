...
// TemporaryEmailApi2 SDK debug feature
...
class TemporaryEmailApi2DebugFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _finish(TemporaryEmailApi2Context $ctx, bool $ok): void
    {
