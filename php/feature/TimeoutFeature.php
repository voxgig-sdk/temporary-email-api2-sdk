...
// TemporaryEmailApi2 SDK timeout feature
...
class TemporaryEmailApi2TimeoutFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _with_timeout(TemporaryEmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TemporaryEmailApi2Context $_ctx, float $ms): void
    {
        $client = $this->client;
