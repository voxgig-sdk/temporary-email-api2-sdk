...
// TemporaryEmailApi2 SDK audit feature
...
class TemporaryEmailApi2AuditFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _emit(TemporaryEmailApi2Context $ctx, string $outcome): void
    {
