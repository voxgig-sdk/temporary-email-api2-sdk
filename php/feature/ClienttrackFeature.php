...
// TemporaryEmailApi2 SDK clienttrack feature
...
class TemporaryEmailApi2ClienttrackFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    public function PostConstruct(TemporaryEmailApi2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TemporaryEmailApi2-SDK';
