...
// TemporaryEmailApi2 SDK netsim feature
...
class TemporaryEmailApi2NetsimFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _simulate(TemporaryEmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TemporaryEmailApi2Context $ctx, array $applied): void
    {
        $client = $this->client;
