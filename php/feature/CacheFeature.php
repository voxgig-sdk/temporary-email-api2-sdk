...
// TemporaryEmailApi2 SDK cache feature
...
class TemporaryEmailApi2CacheFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _through(TemporaryEmailApi2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
