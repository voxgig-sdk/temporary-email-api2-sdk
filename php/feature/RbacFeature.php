...
// TemporaryEmailApi2 SDK rbac feature
...
class TemporaryEmailApi2RbacFeature extends TemporaryEmailApi2BaseFeature
{
    ...
    private function _required(TemporaryEmailApi2Context $ctx): ?string
    {
    ...
    private function _reject(TemporaryEmailApi2Context $ctx, string $required): void
    {
    ...
    private function _track(TemporaryEmailApi2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
