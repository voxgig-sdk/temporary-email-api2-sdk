...
// TemporaryEmailApi2 SDK utility: result_basic

class TemporaryEmailApi2ResultBasic
{
    public static function call(TemporaryEmailApi2Context $ctx): ?TemporaryEmailApi2Result
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TemporaryEmailApi2Error) ? $result->err->msg : (string)$result->err;
