...
// TemporaryEmailApi2 SDK utility: graphql
//
...
class TemporaryEmailApi2Graphql
{
    ...
    // equivalent.
    public static function body(TemporaryEmailApi2Context $ctx): mixed
    {
    ...
    public static function errors(TemporaryEmailApi2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
