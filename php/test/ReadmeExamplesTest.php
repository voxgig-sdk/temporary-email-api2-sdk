...
// TemporaryEmailApi2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TemporaryEmailApi2SDK::test)
...
{
    private const SDK_CLASS = 'TemporaryEmailApi2SDK';
    ...
    private const SDK_BASE = 'temporaryemailapi2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../temporaryemailapi2_sdk.php';
