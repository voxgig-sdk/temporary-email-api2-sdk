...
class EmailGenerationDirectTest extends TestCase
{
    public function test_direct_load_email_generation(): void
    {
        $setup = email_generation_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-email_generation", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
