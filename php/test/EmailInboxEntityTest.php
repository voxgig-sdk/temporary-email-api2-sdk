...
class EmailInboxEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TEMPORARYEMAILAPI__TEST_EMAIL_INBOX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function email_inbox_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TEMPORARYEMAILAPI__TEST_EMAIL_INBOX_ENTID");
