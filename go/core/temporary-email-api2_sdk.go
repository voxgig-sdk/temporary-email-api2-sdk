...
type TemporaryEmailApi2SDK struct {
	Mode     string
...
func (sdk *TemporaryEmailApi2SDK) OptionsMap() map[string]any {
...
func (sdk *TemporaryEmailApi2SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *TemporaryEmailApi2SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *TemporaryEmailApi2SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TemporaryEmailApi2SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *TemporaryEmailApi2SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *TemporaryEmailApi2SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("TemporaryEmailApi2SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *TemporaryEmailApi2SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *TemporaryEmailApi2SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("TemporaryEmailApi2SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *TemporaryEmailApi2SDK {
	...
	sdk := NewTemporaryEmailApi2SDK(sdkopts)
	sdk.Mode = "test"
