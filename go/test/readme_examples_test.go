...
const testSeed = `map[string]any{"entity": map[string]any{"email_generation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
