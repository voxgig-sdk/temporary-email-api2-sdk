# TemporaryEmailApi2 Golang SDK Reference

Complete API reference for the TemporaryEmailApi2 Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *TemporaryEmailApi2SDK`
...
#### `EmailGeneration(data map[string]any) TemporaryEmailApi2Entity`

Create a new `EmailGeneration` entity instance. Pass `nil` for no initial data.

#### `EmailInbox(data map[string]any) TemporaryEmailApi2Entity`
