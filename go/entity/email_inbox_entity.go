...
func NewEmailInboxEntity(client *core.TemporaryEmailApi2SDK, entopts map[string]any) *EmailInboxEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EmailInboxEntity) GetName() string { return e.name }
...
func (e *EmailInboxEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EmailInboxEntity) Deleted() bool {
	return e.deleted
}


func (e *EmailInboxEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEmailInboxEntity(e.client, opts)
}

func (e *EmailInboxEntity) Data(args ...any) any {
...
func (e *EmailInboxEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *EmailInboxEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EmailInboxEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EmailInboxEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EmailInboxEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EmailInboxEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EmailInboxEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
