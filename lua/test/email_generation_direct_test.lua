...
describe("EmailGenerationDirect", function()
  it("should direct-load-email_generation", function()
    local setup = email_generation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-email_generation", setup.live and "live" or "unit")
...
function email_generation_direct_setup(mockres)
