...
describe("EmailGenerationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TEMPORARY_EMAIL_API2_TEST_EMAIL_GENERATION_ENTID JSON to run live")
      return
    end
...
function email_generation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TEMPORARY_EMAIL_API2_TEST_EMAIL_GENERATION_ENTID")
