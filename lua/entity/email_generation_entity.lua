...
local EmailGenerationEntity = {}
EmailGenerationEntity.__index = EmailGenerationEntity


function EmailGenerationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EmailGenerationEntity)
  self._name = "email_generation"
  self._client = client
...
function EmailGenerationEntity:get_name()
  return self._name
end


function EmailGenerationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EmailGenerationEntity.new(self._client, opts)
end
...
function EmailGenerationEntity:mark_deleted()
  self._deleted = true
end


function EmailGenerationEntity:deleted()
  return true == self._deleted
end


function EmailGenerationEntity:data_set(args)
  if args ~= nil then
...
function EmailGenerationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EmailGenerationEntity:match_set(args)
  if args ~= nil then
...
function EmailGenerationEntity:match_get()
...
function EmailGenerationEntity:stream(action, args, callopts)
...
---@param reqmatch EmailGenerationLoadMatch
---@param ctrl? table
---@return EmailGeneration
---@return string? err
function EmailGenerationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function EmailGenerationEntity:_run_op(ctx, post_done)
  local utility = self._utility
