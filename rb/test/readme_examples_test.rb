...
#      offline in seeded test mode (TemporaryEmailApi2SDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TemporaryEmailApi2_sdk.rb")
  SDK_CLASS = "TemporaryEmailApi2SDK"
  ...
  SDK_BASE = "TemporaryEmailApi2_sdk"
