...
class EmailGenerationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set TEMPORARYEMAILAPI__TEST_EMAIL_GENERATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def email_generation_basic_setup(extra)
  ...
  entid_env_raw = ENV["TEMPORARYEMAILAPI__TEST_EMAIL_GENERATION_ENTID"]
